...
export interface AssigneeWidgetProps {
  kpi: KpiCalcResult;
  title: string;
  isExpanded: boolean;
...
/**
 * "Open Tickets by Assignee / Team" widget (component type `assignee`).
 * Renders one stacked/segmented age bar per assignee (or team) with an age
 * legend. The `open_tickets_by_issue_owner_team` plugin groups by team.
 */
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    <span
                      ...
                      onClick={() => {
                        ...
                        onDrillDown(allTicketKeys, `${isTeam ? 'Team' : 'Assignee'}: ${key} (All)`);
                      }}
                      ...
                      .map((result, idx) => {
                        ...
                        return (
                          <div
                            ...
                            style={{ width: `${width}%` }}
                            onClick={() => onDrillDown(result.ticketKeys || [], `${key} (${result.dimensions?.ageCategory})`)}
