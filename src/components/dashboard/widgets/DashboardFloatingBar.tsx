  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border border-slate-200 dark:border-slate-800 rounded-full shadow-2xl p-1.5 flex items-center justify-between gap-2 sm:gap-4">
            <div className="flex min-w-0 items-center gap-2 px-2 sm:gap-3 sm:px-3">
              <div
                className="flex min-w-0 items-center gap-1.5 text-xs font-medium text-slate-600 dark:text-slate-400 cursor-pointer rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 px-2 py-1 transition-colors"
              ...
              <TooltipProvider delayDuration={0}>
                ...
                <div
                  className="flex shrink-0 items-center gap-1.5 text-xs font-medium text-slate-600 dark:text-slate-400 cursor-pointer rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 px-2 py-1 transition-colors"
            ...
            <div className="flex shrink-0 items-center gap-1.5 pr-1.5">
              <Button
                size="sm"
                className="rounded-full h-8 px-2 sm:px-4 bg-blue-600 hover:bg-blue-700 text-xs font-bold shadow-lg shadow-blue-600/20 gap-2"
                onClick={onRecalculate}
                disabled={calculating}
              >
                <RefreshCw className={`h-3 w-3 shrink-0 ${calculating ? 'animate-spin' : ''}`} />
                <span className="hidden sm:inline">Recalculate</span>
              </Button>
              <Button
                size="sm"
                variant="ghost"
                className="rounded-full h-8 px-2 text-[10px] font-bold text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 gap-1 hidden sm:inline-flex"
