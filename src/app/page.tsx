      ...
      <main className="container py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          <div className="flex justify-center no-print">
            <TabsList className="bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 p-1 h-12">
              <TabsTrigger value="extract" className="gap-2 px-8 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-950 data-[state=active]:shadow-sm">
                <Database className="h-4 w-4" />
                Data Center
              </TabsTrigger>
              <TabsTrigger value="kpi" className="gap-2 px-8 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-950 data-[state=active]:shadow-sm">
                <BarChart3 className="h-4 w-4" />
                KPI Analytics
              </TabsTrigger>
              <TabsTrigger value="settings" className="gap-2 px-8 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-950 data-[state=active]:shadow-sm">
