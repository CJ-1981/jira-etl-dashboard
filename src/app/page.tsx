        ...
        <div className="container grid grid-cols-[1fr_auto_1fr] lg:grid-cols-[280px_1fr_280px] xl:grid-cols-[320px_1fr_320px] h-16 items-center px-2 sm:px-6 gap-2">
          <div className="flex items-center gap-2 sm:gap-3 pl-2 lg:pl-4 overflow-hidden">
            ...
            <div className="flex flex-col items-start overflow-hidden">
              <h1 className="text-xs sm:text-sm lg:text-base font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-slate-900 to-slate-600 dark:from-white dark:to-slate-400 truncate w-full">
                Jira ETL Dashboard
              </h1>
              <p className="hidden sm:block text-[9px] lg:text-[10px] text-slate-500 dark:text-slate-400 font-medium truncate w-full">
